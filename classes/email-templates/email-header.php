...
class Creare_Reviews_Emails_Header
{
...
<!-- BODY -->
<table style="border-collapse: collapse; margin-top:30px; margin-bottom:0;" class="body-wrap">
  <tr>
	<td></td>
    <td class="container"><div class="content">' . $this->clr_get_heading() . '</div></td>
  </tr>
  <tr>
    <td></td>
